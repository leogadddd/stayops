...
export default async function NewPaymentPageModal({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!membership) return <ReservationActionModal title="Record payment" description="Only the owner can record money for a reservation."><PermissionDenied /></ReservationActionModal>;
